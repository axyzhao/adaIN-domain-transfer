...
parser.add_argument('--decoder', type=str, default='experiments/decoder_experiment.pth.tar')
...
model.optimizer = optim.SGD(model.parameters(), lr=5e-5, momentum=0.9, weight_decay=5e-4)
